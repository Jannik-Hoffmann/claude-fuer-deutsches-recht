...
description: Statusfeststellung für eine geplante Beschäftigung – Abgrenzung Arbeitnehmer/Selbständiger nach § 611a BGB, Scheinselbständigkeit, Clearingverfahren § 7a SGB IV, AÜG-Abgrenzung (Leiharbeit vs. Werkvertrag). Ausschließlich prospektiv – für bestehende Verhältnisse Außenberater einschalten. Auslöser und Beispielanfragen: arbeitnehmer-status; scheinselbständigkeit; arbeitnehmer oder selbständig; worker classification; freier mitarbeiter; honorarvertrag prüfen; § 7a sgb iv.
---
