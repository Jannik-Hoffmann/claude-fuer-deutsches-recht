...
description: Zeigt Verträge mit ablaufenden Kündigungsfristen an und warnt rechtzeitig, bevor Verlängerungs-/Kündigungsfenster schließen. Relevant insbesondere bei § 309 Nr. 9 BGB (automatische Verlängerung). Laden, wenn der Nutzer fragt „welche Verträge laufen aus", „wann muss ich kündigen", „habe ich eine Frist verpasst", oder bei geplanter Aktualisierung des Registers. Auslöser und Beispielanfragen: vertragsverlaengerungs-monitor; vertragsfrist; kündigungsfrist; vertrag kündigen; renewal tracker; vertragsverlängerung.
---
