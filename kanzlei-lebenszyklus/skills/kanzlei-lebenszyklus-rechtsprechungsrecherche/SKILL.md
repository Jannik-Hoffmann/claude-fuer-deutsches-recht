---
name: kanzlei-lebenszyklus-rechtsprechungsrecherche
...
- Für Klage, Replik oder Antrag: Ergebnisse an `kanzlei-lebenszyklus-schriftsatz-turbo` übergeben.
- Für Vertrag: Risiken an `kanzlei-lebenszyklus-vertragsentwurf` übergeben.
- Für finale Ausgabe: `kanzlei-lebenszyklus-qualitaetsgate-hardening` ausführen.
- Für Fristen oder Monitoring: `kanzlei-lebenszyklus-automationen` nur mit ausdrücklicher Zustimmung nutzen.
