...
Das ist der Hauptlauf. Wenn der Würfel 25 Spalten 200 Zeilen und 5 Arbeitsblätter hat sind das 25.000 Zellen. Jede Zelle braucht: Antwort + woertliches Zitat + Fundstelle + Ampel + Prüfer-Flag.
...
2. **Quelldokument oeffnen:** Pfad + Hash gegen Inventar abgleichen — falls Hash abweicht: Belegkette unterbrochen Prüfer-Flag setzen.
...
4. **Belegkette schreiben:** woertliches Zitat in Anführungszeichen, danach Fundstelle (Datei-ID + Seite + Absatz + ggf. Ziffer).
...
8. **Cache prüfen:** bei Quasi-Duplikaten (Ähnlichkeit über 95 Prozent) zur Zelle eines bereits geprueften Dokuments Cache-Treffer vorschlagen — Prüfer entscheidet ob übernommen.
...
Jede Zelle ist ein Hinweis kein Befund. Prüfer-Flags sind die wichtigste Ausgabe — sie sagen wo der menschliche Prüfer hinschauen muss. Untermarkierung ist eine Einbahnstrasse; Uebermarkierung ist eine Zweiwegtür die ein Anwalt in 30 Sekunden schliesst.
